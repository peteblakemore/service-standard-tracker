...
const artefactsByStandard = {
  1: [
    { id: 'user-needs-register', title: 'User Needs Register', detail: 'A structured list of user needs captured in plain language, typically using the format “As a [user], I need to [do something] so that [goal].” In Alpha, the register contains prioritised needs identified through research, free of solutions or internal jargon. By Beta, it is updated with supporting evidence, status of how each need is being addressed, and links to user stories or backlog items. In Live, it continues to evolve through ongoing research and feedback, helping the team monitor whether the service still meets users’ needs. The register is a key artefact for Standard 1, often presented as a spreadsheet or Trello board with tags for priority, status, and user group.' },
